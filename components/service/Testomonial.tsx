...
const Testimonial: React.FC<TestimonialProps> = ({
  ...
  return (
    <div className={` max-w-7xl mx-auto  lg:px-12 relative bg-blue-600 rounded-4xl py-20 my-10 md:my-15 ${className}`}>
      {/* Opening Quote Mark */}
      <div className="absolute -top-4 md:top-6 left-0 md:left-20 overflow-hidden z-10">
        <svg
          width="120"
          height="120"
          viewBox="0 0 80 60"
          fill="none"
          className="text-gray-200 w-20 h-20"
        >
          <path
      ...
      <div className="max-w-6xl mx-auto text-center">
        {/* Main Quote Text */}
        <p className="text-xl md:text-2xl text-white font-medium leading-relaxed px-4">
