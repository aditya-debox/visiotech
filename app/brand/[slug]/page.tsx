...
export default async function Page({ params }: PageProps) {
    ...
    try {
        ...
        console.log('Available brands:', response.brands.map(b => b.slug)); // Debug log
        
        const brandData = response.brands.find(brand => brand.slug === params.slug);
        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="text-center max-w-md mx-auto px-6">
                    ...
                    <h1 className="text-4xl font-bold text-red-600 mb-4">Error Loading Brand</h1>
