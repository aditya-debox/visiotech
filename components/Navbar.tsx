          ...
          <div className="flex justify-between items-center px-6 lg:px-12 w-full max-w-7xl mx-auto">
            <div className="flex items-center">
              <Link
                ...
                prefetch={false}
                passHref
                className="relative w-[90px] sm:w-[120px] md:w-[140px] h-[80px] mr-10 flex flex-shrink-0"
              >
                <Image
                  src={logo || ""}
                  alt="logo"
            ...
            <div
              className="block bg-blue-600 text-white font-secondary items-center justify-center rounded-full px-4 text-sm active:bg-blue-800 active:text-blue-100"
              onClick={() => setTriggerModal(true)}
            >
              <button className="cursor-pointer py-1.5">Get Started</button>
            </div>
